...
Hello! Thanks for contributing.  For the fastest response and resolution, please:
 ...
 - Only post to report a bug. For feature requests, please use https://github.com/mapvina/mapvina-gl-js/issues/new?template=Feature_request.md instead.  Direct all other questions to https://stackoverflow.com/questions/tagged/mapvina-gl-js

-->

**mapvina-gl-js version**:
...
E.g. `<script src='https://unpkg.com/mapvina-gl@1.15.2/dist/mapvina-gl-dev.js'></script><link href='https://unpkg.com/mapvina-gl@1.15.2/dist/mapvina-gl.css' rel='stylesheet' />`
