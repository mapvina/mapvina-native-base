...
Let's assume you want to create a line gradient to be used in MapVina Native. We can programatically construct the data structure as we would do it if the data comes from a backend data source:
...
See https://mapvina.com/mapvina-style-spec/layers/#line-gradient to learn more about line gradients.
